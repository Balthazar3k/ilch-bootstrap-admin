...
if ( isset($_POST['sub']) ) {
  ...
  <legend><h2><i class="fa fa-info-circle"></i> Impressum</h2></legend>
...
<div class="form-group">
    <label></label>
<div class="col-sm-10">
	<textarea class="form-control" rows="5" name="t1"><?php echo unescape($t); ?></textarea>
<span class="help-block"><i class="fa fa-code"></i> HTML-Code im Text m&ouml;glich.</span>
  </div></div>
<div class="form-group">
    <label></label>
<div class="col-sm-10">
