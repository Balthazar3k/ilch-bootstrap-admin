...
function gallery_admin_showcats ( $id , $stufe ) {
  ...
  $q = "SELECT * FROM prefix_gallery_cats WHERE cat = ".$id." ORDER BY pos";
	...
	if ( db_num_rows($erg) > 0 ) {
	  ...
	  echo '<tr><td>'.$stufe.'<a href="?gallery-S'.$row->id.'">'.$row->name.'</a><br><small>'.$row->besch.'</small></td>';
      echo '<td><a href="javascript:uploadImages('.$row->id.')"rel="tooltip" title="Bilder in diese Kategorie hochladen"><i class="fa fa-upload"></i></a></td>';
      echo '<td><a href="javascript:reloadImages('.$row->id.')" rel="tooltip" title="Bilder in diese Kategorie erneuern / einlesen"><i style="color:#963C00;" class="fa fa-refresh"></i></a></td>';
      echo '<td nowrap><a style="margin-right:5px;" href="admin.php?gallery-E'.$row->id.'#edit" rel="tooltip" title="&auml;ndern"><i style="color:#298900;" class="fa fa-pencil-square-o"></i></a>
<a style="margin-right:5px;" href="javascript:Kdel('.$row->id.')" rel="tooltip" title="l&ouml;schen"><i style="color:#A80000;" class="fa fa-trash-o"></i></a>
<a style="margin-right:5px;" href="admin.php?gallery-M'.$row->id.'-o'.$row->pos.'" rel="tooltip" title="nach oben verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-up"></i></a>
<a href="admin.php?gallery-M'.$row->id.'-u'.$row->pos.'" rel="tooltip" title="nach unten verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-down"></i></a></td></tr>';
