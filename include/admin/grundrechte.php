...
if (isset($_POST['o'])) {
  ...
  echo '<div class="alert alert-success" role="alert"><i class="fa fa-check-square-o"></i> Die Aenderungen wurden gespeichert</div>';
}
...
<tr>
     <td colspan="2"><input class="btn btn-primary" type="submit" value="&Auml;nderungen speichern" name="o"> (<a href="admin.php?grundrechte=0&m=m">Modulrechte f&uuml;r Grundrechte</a>)</td>
  </tr>
  <?php
  $class = '';
  $erg = db_query("SELECT * FROM prefix_grundrechte ORDER BY id ASC");
