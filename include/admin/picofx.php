...
<div class="cont_loose">
    <legend><h2><i class="fa fa-picture-o"></i> Pic of the X verwalten</h2></legend>
...
<br><span class="help-block"><i class="fa fa-info-circle"></i> Nur ausf&uuml;llen wenn oben "selbstdefiniert" ausgew&auml;hlt ist! Andernfalls wird dieses Feld ignoriert.</span>
    </div>
  </div>
  <div class="form-group">
