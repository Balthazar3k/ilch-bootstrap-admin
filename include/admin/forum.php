  ...
  $q = "SELECT * FROM prefix_forumcats WHERE cid = ".$id." ORDER BY pos";
	...
	if ( db_num_rows($erg) > 0 ) {
 	  while ($row = db_fetch_object($erg) ) {
	    echo '<tr><td>'.$stufe.' <i class="fa fa-paper-plane-o"></i> <a href="?forum-S'.$row->id.'">'.$row->name.'</a></td>';
      echo '<td nowrap><a style="margin-right:5px;" href="admin.php?forum-changeCategorie-'.$row->id.'" rel="tooltip" title="Kategorie &auml;ndern"><i style="color:#2D9600;" class="fa fa-pencil-square-o"></i></a>
<a style="margin-right:5px;" href="javascript:delCcheck('.$row->id.')" rel="tooltip" title="Kategorie l&ouml;schen"><i style="color:#AD0000;"class="fa fa-times"></i></a>
<a style="margin-right:5px;" href="admin.php?forum-moveCategorie-0-'.$row->id.'-'.$row->pos.'" rel="tooltip" title="nach oben verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-up"></i></a>
<a href="admin.php?forum-moveCategorie-1-'.$row->id.'-'.$row->pos.'" rel="tooltip" title="nach unten verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-down"></i></a></a></td></tr>';
