...
if ( $show ) {
  ...
  $class = 'Cnorm';
    ...
    if ( $r['func'] < 3 ) {
		  echo '<td class="text-center" nowrap><a style="margin-right:5px;" href="?profilefields-edit-'.$r['id'].'" rel="tooltip" title="&auml;ndern"><i style="color:#2D9600;" class="fa fa-pencil-square-o"></i></a><a href="javascript:delcheck('.$r['id'].')" rel="tooltip" title="l&ouml;schen"><i style="color:#AD0000;"class="fa fa-times"></i></a></td>';
		} else {
    ...
    echo '<td nowrap><a style="margin-right:5px;" href="?profilefields-o-'.$r['id'].'-'.$r['pos'].'" rel="tooltip" title="nach oben verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-up"></i></a><a href="?profilefields-u-'.$r['id'].'-'.$r['pos'].'" rel="tooltip" title="nach unten verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-down"></i></a></td>';
	  echo '</tr>';
	}
	$tpl->out(2);
