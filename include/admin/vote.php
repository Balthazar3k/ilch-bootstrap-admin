...
echo '<legend><h2><i class="fa fa-question"></i> Umfrage</h2></legend>';
...
while ($row = db_fetch_object($erg)) {
    ...
    echo '<tr>';
    echo '<td><i class="fa fa-location-arrow"></i> <strong>' . $row->frage . '</strong><br><div class="btn-group btn-group-sm"><a  class="btn btn-danger" href="javascript:delcheck(' . $row->poll_id . ')">l&ouml;schen</a>
