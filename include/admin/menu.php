...
function show_menu ( $wo ) {
  $erg = db_query("SELECT * FROM prefix_menu WHERE wo = ".$wo." ORDER BY pos");
	$x = 0;
	$class = '';
  echo '<div class="panel panel-default" style="overflow-x:auto;overflow-y:hidden;"><div class="panel-heading"><table class="table">';
    ...
    echo '<tr><td><span class="badge">'.$row['pos'].'</span></td><td>'.($whileMenP?'':'<b>').($whileMenP?str_repeat('-&nbsp;',$row['ebene']+1):'').$row['name'].($whileMenP?'':'</b>').'</td>';
    echo '<td class="text-right" nowrap><a href="?menu-'.$row['wo'].'-l-'.$row['pos'].'" rel="tooltip" title="nach links"><i style="color:#C64F00;" class="fa fa-long-arrow-left"></i></a>
<a style="margin-right:4px;" href="?menu-'.$row['wo'].'-r-'.$row['pos'].'" rel="tooltip" title="nach rechts"><i style="color:#C64F00;" class="fa fa-long-arrow-right"></i></a>
<a style="margin-right:4px;" href="?menu-'.$row['wo'].'-o-'.$row['pos'].'" rel="tooltip" title="nach oben verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-up"></i></a>
<a style="margin-right:4px;" href="?menu-'.$row['wo'].'-u-'.$row['pos'].'" rel="tooltip" title="nach unten verschieben"><i style="color:#C64F00;" class="fa fa-long-arrow-down"></i></a>
<a style="margin-right:4px;"  href="javascript:delcheck(\''.$row['pos'].'\',\''.$row['wo'].'\')" rel="tooltip" title="l&ouml;schen"><i style="color:#AD0000;"class="fa fa-times"></i></a>
<a href="?menu-'.$row['wo'].'-edit-'.$row['pos'].'" rel="tooltip" title="&auml;ndern"><i style="color:#2D9600;" class="fa fa-pencil-square-o"></i></a></td>';
    echo '</tr>';
  }
	echo '</table></div></div>';
}
